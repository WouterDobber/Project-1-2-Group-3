...
class Test_ProbeSimulator {

    static final double ACCURACY = 1e7; // 1 meter (might need to tweak that)
    ...
    public static Vector3dInterface[] simulateOneDay() {
      ...
      double day = 24*60*60;
      double step = day;
      ProbeSimulatorInterface simulator = new Probe();
      Vector3dInterface[] trajectory = simulator.trajectory(probe_relative_position, probe_relative_velocity, day, step);
      return trajectory;
    ...
    public static Vector3dInterface[] simulateOneYear() {
      ...
      double step = day;
      ProbeSimulatorInterface simulator = new Probe();
      Vector3dInterface[] trajectory = simulator.trajectory(probe_relative_position, probe_relative_velocity, year, step);
      return trajectory;
